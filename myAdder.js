...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'myAdder.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'myAdder.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'myAdder.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "myAdder.js.mem" : null;
...
var real__myAdder = asm["_myAdder"]; asm["_myAdder"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real__myAdder.apply(null, arguments);
};
...
var _myAdder = Module["_myAdder"] = asm["_myAdder"];
